...
2. **Given** a client sends a simulation command, **When** the AI assistant observes the command feed, **Then** it sees the raw command that was sent (command type and parameters).
