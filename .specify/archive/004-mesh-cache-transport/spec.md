...
**Created**: 2026-03-23
**Status**: Completed
**Last Modified**: 2026-03-23 (sync: applied drift resolutions for FR-010, FR-011, added FR-016)
...
- What happens when a compound shape contains children that are themselves mesh types? The compound is cached as an atomic unit with a single content-addressed identifier derived from all children. Identical compound structures share the same identifier.
