...
Usage: python -m demos_py.auto_run [server-address]
"""

import sys

from demos_py.all_demos import demos
from demos_py.prelude import connect, disconnect, reset_simulation, sleep
